...
public class OwnerPage implements Initializable {
    ...
    @FXML
    private JFXHamburger admin_burg;

    @FXML
    private JFXDrawer admin_drawer;
    ...
    @FXML
    public void CheckReport(ActionEvent event) throws IOException{
        Main.Loader("/Assets/FXMLs/Report.fxml");
    }
    @FXML
...
void reset_pass()throws IOException{
    ...
    {
        try {
            VBox box = FXMLLoader.load(getClass().getResource("/Assets/FXMLs/AdminDrawer.fxml"));
            admin_drawer.setSidePane(box);
        ...
        HamburgerBackArrowBasicTransition burgertask2 = new HamburgerBackArrowBasicTransition(admin_burg);
        burgertask2.setRate(-1);
        admin_burg.addEventHandler(MouseEvent.MOUSE_PRESSED,(event -> {
            burgertask2.setRate(burgertask2.getRate() * -1);
            burgertask2.play();
            if(admin_drawer.isOpened())
            {
                admin_drawer.close();
            }
            else
